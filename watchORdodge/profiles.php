...
<main>
	...
	<section>
		...
		<?php 
			$query_reviews = "SELECT reviews.date, reviews.rating, reviews.body, movies.title, movies.moviepic
							  FROM reviews, movies
		...
		?>
		<h4><a href="#"><?php echo $row_reviews['title']; ?></a></h4>
		<a href="#"><img src="#" alt="moviepic"></a>
