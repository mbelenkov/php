<?php
  $thisTitle = "Privacy Policy";
  $thisPage = "dPrivacyPolicy";
?>
...
<main>
	<section>
		...
		<p>We are the sole owners of the information collected on this site. We only have access to/collect information that you voluntarily give us via email or other direct contact from you. We will not sell or rent this information to anyone.<br/><br/>
		...
		<h3>Security</h3>
		<p>We take precautions to protect your information. When you submit sensitive information via the website, your information is protected both online and offline.<br/><br/>
		...
		<h3>Updates</h3>
		<p>Our Privacy Policy may change from time to time and all updates will be posted on this page.<br/><br/>

		If you feel that we are not abiding by this privacy policy, you should contact us immediately via telephone at XXX YYY-ZZZZ or via email.<br/><br/>

		The above notice (or policy) probably does not describe your privacy practices exactly. You need to personalize your statement to fit your business practices. Here are some sample clauses that you can use to help describe other specific practices that fit your business model:</p>

		<h2>Optional Clauses</h2>

		<p>If your site has a registration page that customers must complete to do business with you, insert a paragraph like this in your privacy policy:</p>
