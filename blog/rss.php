...
<rss version="2.0" xmlns:atom="http://www.w3.org/2005/Atom">
	<channel>
		<title>Maksim's Blog</title>
		<link>http://localhost/maxBelenkov/blog/</link>
		<description>A blog about movies and food.</description>
		...
		<item>
			...
			<link>http://localhost/maxBelenkov/blog/single.php?post_id=<?php echo $row['post_id']; ?></link>
			<guid>http://localhost/maxBelenkov/blog/single.php?post_id=<?php echo $row['post_id']; ?></guid>
			<pubDate><?php echo rss_date($row['date']); ?></pubDate>
			<author><?php echo $row['email']; ?> (<?php echo $row['username']; ?>)</author>
			<!-- The CDATE wrapper allows us to have HTML in the body of the post -->
