<?php
	...
	// get all the posts whose title or body matches the phrase
...
?>
	<main>
		...
		<h2><?php echo $total ?> Search Results:</h2>
		...
		<section class="pagination">
			...
			<a href="search.php?phrase=<?php echo $phrase; ?>&amp;page=<?php echo $prev_page; ?>" class="prev">Previous Page</a> | 
			<?php } else { ?>
			...
			?>
			<a href="search.php?phrase=<?php echo $phrase; ?>&amp;page=<?php echo $next_page; ?>" class="next">Next Page</a>
			<?php } else { ?>
			...
			?>
			<a href="search.php?phrase=<?php echo $phrase; ?>&amp;page=<?php echo $counter; ?>"><?php echo $counter; ?></a>
			<?php	
					} else { // end if
						echo "<span class='unavailable'>$counter</span>"; // the current page
					}
					$counter++;
				} // end of numbered pagination while loop
			?>
		</section>
		<?php
			} else { // end if valid page
				echo 'Invalid Page';
			}
			} else { 
